...
const HangmanDrawing = ({ attempts }: { attempts: number }) => {
    return (
        <div className="relative w-64 h-64 flex justify-center bg-white/5 rounded-xl border border-white/10">
            {/* Gallows */}
...
const Hangman: React.FC = () => {
    ...
    const handleGuess = (char: string) => {
        ...
        if (!word.includes(char)) {
            ...
            const isWon = word.split('').every(c => newGuessed.has(c));
        ...
        <div className="flex flex-col items-center w-full max-w-4xl mx-auto">
            <div className="flex items-center justify-between w-full mb-8">
                ...
                <button
                    ...
                    className="p-2 hover:bg-white/10 rounded-full transition-colors text-green-300"
                >
                ...
                <div className="flex-1 flex flex-col gap-6">
                    <div className="glass-panel p-6 rounded-2xl">
                        ...
                        <button
                            ...
                            className="w-full py-3 bg-white/10 hover:bg-white/20 rounded-xl flex items-center justify-center gap-2 transition-colors font-bold"
                        >
                            <RefreshCw size={20} />
                            New Game
                        </button>
